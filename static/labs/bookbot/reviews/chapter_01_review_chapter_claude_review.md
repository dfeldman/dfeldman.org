...
- Some metaphors feel forced or overdone:
  "sunlight streaming through stained glass" is cliché
...
1. Start with Vivian legitimately entering museum
2. Establish her regular visits to the throne room
3. Show interaction with Guard Joe
4. Introduce Celeste naturally as docent
5. Build tension before attack
6. Make Vito's entrance more organic

Middle Scene (Newsroom):
1. Show travel from museum
2. Establish newsroom dynamics
3. Build Fletcher conflict gradually
4. Make Eleanor's appearance natural
5. Develop Lydia's role
6. Create plausible message delivery

Closing Scene (Speakeasy):
1. Show how Vivian found location
2. Establish speakeasy atmosphere
3. Develop Vito's character
4. Make Carlo's appearance logical
5. Build tension before raid
6. End with clear story progression

SPECIFIC LINE EDITS:

Replace:
"The smell hit me first" - too modern
With:
"Museum air settled around me, heavy with memory"

Replace:
"hair black as the void between stars" - purple prose
With:
"dark hair slicked back with precision"

Replace:
"Curiosity kills, Red" - cliché
With:
More period-appropriate warning

HISTORICAL DETAILS TO ADD:
- 1929 police procedure
- Period-accurate medical treatment
- Authentic speakeasy operations
- Newspaper office protocols
...
The chapter shows promise but needs careful revision to maintain historical accuracy and logical plot progression while developing characters more naturally. Each scene should flow organically from the previous one, with clear cause-and-effect relationships between events.